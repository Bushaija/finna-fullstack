...
export function PlanTable({ 
  ...
  // Calculate grand totals for all activities
  const grandTotals = useMemo(() => {
    return activities.reduce((totals, activity) => {
      totals.amountQ1 += activity.amountQ1 || 0;
      totals.amountQ2 += activity.amountQ2 || 0;
      totals.amountQ3 += activity.amountQ3 || 0;
      totals.amountQ4 += activity.amountQ4 || 0;
      totals.totalBudget += activity.totalBudget || 0;
      return totals;
    }, {
      amountQ1: 0,
      amountQ2: 0,
